				 ...
				 if ( is_active_sidebar( 'photograph_footer_options' ) ) :
					...
					<div class="copyright">
						<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
									<?php esc_html_e('Designed by: Ross Montgomery |','photograph'); ?> <a title="<?php echo esc_attr__( 'Theme Freesia', 'photograph' ); ?>" target="_blank" href="<?php echo esc_url( 'https://themefreesia.com' ); ?>"><?php esc_html_e('Theme Freesia','photograph');?></a> |
